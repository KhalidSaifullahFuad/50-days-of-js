...
function spaceAge(seconds){
    ...
    for (let planet in orbitalPeriods) {
        yearsInAllPlanets[planet] = ((seconds/earthYear)/orbitalPeriods[planet]).toFixed(2);
    }
...
// Test Cases
console.log(spaceAge(436575687)); // should return { "Mercury": 57.44, "Venus": 22.49, "Earth": 13.83, "Mars": 7.36, "Jupiter": 1.17, "Saturn": 0.47, "Uranus": 0.16, "Neptune": 0.08 }
console.log(spaceAge(3407706)); // should return { 'Mercury': 8.68 'Venus': 3.4 'Earth': 2.09 'Mars': 1.11 'Jupiter': 0.18 'Saturn': 0.07 'Uranus': 0.02 'Neptune': 0.01 }